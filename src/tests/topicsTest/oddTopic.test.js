...
it("I choose a topic, check the challenge of the topic, move cards from deck to playerboard, calculate the likes and reports", () => {
    ...
    expect(G.players[0].board.yellow.length).toEqual(1);
    expect(G.players[0].board.green.length).toEqual(1);
    expect(G.players[0].board.red.length).toEqual(1);
